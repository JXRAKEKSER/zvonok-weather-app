<template>
  ...
  >
    ...
    <!-- Dots at bottom -->
    <circle fill="#c4c4c4" cx="26.5" cy="57.63" r="2" />
    <circle fill="#e0e0e0" cx="36.5" cy="60.63" r="1.5" />
    <circle fill="#e0e0e0" cx="18.5" cy="53.63" r="1.5" />
    <circle fill="#fff" cx="32.5" cy="53.63" r="1" />
    <circle fill="#fff" cx="46.5" cy="60.63" r="1" />
    <circle fill="#fff" cx="17.5" cy="60.63" r="1" />
    <circle fill="#c4c4c4" cx="42.5" cy="54.63" r="2" />
  </svg>
</template>
